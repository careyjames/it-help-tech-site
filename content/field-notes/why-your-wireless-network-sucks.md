...
Most network problems are not router problems — they are *chain* problems. After fifteen years of doing this work in San Diego homes and businesses, the pattern is consistent: the speed you are paying your ISP for is almost always available *somewhere* in the chain; the question is whether the cabling, the switches, the connectors, the grounding, and the access points between the demarcation point and your laptop are good enough to deliver it intact.
...
- **10 Gbps symmetric to a laptop.** I had a client paying for 10 Gbps service who could not get above ~1 Gbps on any device. The bottleneck was the 1 GbE NIC on the laptop itself. A 10 GbE Thunderbolt/USB adapter, paired with a 10 GbE-capable switch and Cat6A throughout, delivered the full ten down and ten up at the endpoint. The service was real; the chain just had to be made worthy of it.
