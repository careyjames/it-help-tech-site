...
### 2026-02-08
- Actor: AI+Developer
- Scope: Schedule CTA modernization + tagline anti-brown transparency pass
- Files:
  - `static/css/late-overrides.css`
  - `STYLE_GUIDE.md`
- Change: Applied a button-33-inspired 3D style to `Schedule` (updated blue gradient, inset highlight, outer ring/shadow stack, and press-state scale), increased hero tagline interior translucency without blur, shifted framed gold treatment toward a cleaner gold gradient, and tuned tagline highlight gold to stay crisp and less brown/muddy.
- Why: User requested a more modern button treatment and reported the tagline panel still reading brown/heavy instead of clean/translucent.
- Rollback: this branch/PR (`codex/schedule-3d-and-tagline-clarity-v1`).
