...
### 2026-04-25 — `apple-sends-you-to-ijail` ("Don't Guess Wrong") correction: iPhone passcode escalation table was off by 2 attempts and missing the 3-hour and 8-hour stages; unsourceable "six consecutive failures" account-lockout threshold removed; iOS 26 "Request Access" alert button added; Google sign-in challenges separated from (unlimited-attempt) recovery flow; Apple recovery wait-times tiered; URLs migrated to canonical paths
