...
- If a single glyph remains problematic after global tuning (for example the `P` shoulder), isolate that glyph in markup and apply a per-glyph desktop optical correction before broadening global changes.
